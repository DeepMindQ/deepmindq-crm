...
export function CommandCenter() {
  ...
  useEffect(() => {
    const tick = setInterval(() => {
      const base = new Date('2025-01-10T02:37:00').getTime();
      ...
      <div className="min-h-screen" style={{ background: 'var(--ios-bg-primary)' }}>
        <div className="max-w-[1600px] mx-auto px-6 py-8 space-y-8">
          ...
          <StaggerGrid className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <StaggerItem>
              <StatCard label="Active Models" value={7} icon={Brain} color="#8B5CF6" delay={0.1} />
            </StaggerItem>
            <StaggerItem>
              <StatCard
            ...
            <StaggerItem>
              <StatCard label="Queue Depth" value={42} icon={Layers} color="#F59E0B" delay={0.25} />
            </StaggerItem>
          </StaggerGrid>
