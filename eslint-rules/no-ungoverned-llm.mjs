...
const ALLOWED_GOVERNANCE_FILES = new Set([
  ...
  "reasoning/engine.ts", // Intelligence reasoning engine (uses callLLM via llm-client; TODO: route through governance layer once ai-governance.ts is implemented)
]);
