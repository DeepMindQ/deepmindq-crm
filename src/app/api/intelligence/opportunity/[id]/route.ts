...
export async function GET(
  ...
  // ── Step 2: Run engines in parallel (non-throwing) ──────────────────────
  const [scoringResult, reasoningResult, actionResult] = await Promise.allSettled([
  ...
  // ── Step 3: Load fusion results ────────────────────────────────────────
  let fusionData: IntelligenceOpportunity['fusion'] = [];
  try {
  ...
  // ── Step 5: Compose IntelligenceOpportunity ──────────────────────────────
  ...
  const data: IntelligenceOpportunity = {
    companyId,
    scores: scoring as RevenueScore,
    reasoning: {
    ...
    fusion: fusionData,
    actions: actions as ActionResult,
  };
