          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-primary mt-0.5 tabular-nums">{summary?.pending ?? items.filter(i => i.status === 'pending').length}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-primary mt-0.5 tabular-nums">{summary?.scheduled ?? items.filter(i => i.status === 'scheduled').length}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-emerald-400 mt-0.5 tabular-nums">{summary?.sentToday ?? items.filter(i => i.status === 'sent').length}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-red-400 mt-0.5 tabular-nums">{summary?.failed ?? items.filter(i => i.status === 'failed').length}</p>
              </div>
