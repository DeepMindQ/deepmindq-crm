...
export const tokens: Record<string, any> = {
  ...
  confidence: {
    high: { value: '#16A34A', bg: '#DCFCE7', border: '#BBF7D0' },
    medium: { value: '#D97706', bg: '#FEF3C7', border: '#FDE68A' },
    low: { value: '#DC2626', bg: '#FEE2E2', border: '#FECACA' },
    critical: { value: '#991B1B', bg: '#FEE2E2', border: '#FECACA' },
  },
  domain: {
    value: '#7C3AED',
    bg: '#EDE9FE',
  ...
  trust: {
    verified: '#16A34A',
    unverified: { value: '#6B7280', low: '#FCA5A5' },
    high: { value: '#16A34A', bg: '#DCFCE7' },
    medium: { value: '#D97706', bg: '#FEF3C7' },
    low: { value: '#DC2626', bg: '#FEE2E2' },
  },
  opacity: {
    disabled: '0.5',
    white: '0.8',
