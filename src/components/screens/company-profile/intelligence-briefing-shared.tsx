...
import { CheckCircle2, AlertTriangle, AlertCircle, ShieldCheck, ShieldAlert, RefreshCw } from 'lucide-react'
import { Button } from '@/components/ui/button'

/* ═══════════════════════════════════════════════════
   Company Profile — Shared Intelligence Briefing Components
   Extracted from company-profile-screen.tsx (Task 3.2)
   ═══════════════════════════════════════════════════ */

/** Governance status badge — Design Bible §6.2 */
export function GovernanceBadge({ status }: { status: 'verified' | 'needs_review' | 'failed' | 'not_evaluated' | null | undefined }) {
