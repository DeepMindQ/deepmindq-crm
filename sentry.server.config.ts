...
Sentry.init({
  ...
  // Profile sample rate for performance profiling (10%)
  // Note: requires Sentry profiling integration
  ...
  // Enable replays for error sessions (capture what user saw before error)
