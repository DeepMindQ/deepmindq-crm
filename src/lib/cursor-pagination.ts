 ...
 */
export function encodeCursor(value: { id: string; createdAt?: string; updatedAt?: string }): string {
 ...
 */
export function decodeCursor(cursor?: string): { id: string; createdAt?: string; updatedAt?: string } | null {
 ...
 */
export function buildCursorWhere(cursor: ReturnType<typeof decodeCursor>, field: string = 'createdAt'): Record<string, unknown> {
  if (!cursor) return {};
