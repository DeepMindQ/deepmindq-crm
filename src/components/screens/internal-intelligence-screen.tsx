...
const MOCK_INTEL: IntelItem[] = [
  {
    id: 'ii1',
    title: 'Salesforce shifting to AI-first pricing model',
  ...
  {
    id: 'ii2',
    title: 'Acme Corp deal: champion just got promoted to VP',
    category: 'deal',
    author: 'James Wilson',
    confidentiality: 'team',
    created: '2025-01-22',
  ...
  {
    id: 'ii3',
    title: 'New competitor: VelocityAI entering mid-market',
    category: 'competitive',
    author: 'Maria Garcia',
  ...
  {
    id: 'ii4',
    title: 'Product roadmap: AI advisor v2 features finalized',
    category: 'product',
    author: 'David Kim',
    confidentiality: 'team',
    created: '2025-01-21',
  ...
  {
    id: 'ii5',
    title: 'Market trend: PLG overtaking SLG in SaaS',
    category: 'market',
    author: 'Emily Zhang',
    confidentiality: 'public',
    created: '2025-01-20',
  ...
  {
    id: 'ii6',
    title: 'HubSpot adding native AI scoring — threat level high',
    category: 'competitive',
  ...
  {
    id: 'ii7',
    title: 'Vertex AI deal: procurement starting next week',
    category: 'deal',
    author: 'Priya Patel',
    confidentiality: 'team',
    created: '2025-01-19',
  ...
  {
    id: 'ii8',
    title: 'Enterprise dashboard redesign — user testing results',
    category: 'product',
    author: 'Alex Rivera',
    confidentiality: 'team',
    created: '2025-01-19',
  ...
  {
    id: 'ii9',
    title: 'Healthcare IT compliance changes for 2025',
    category: 'market',
  ...
  {
    id: 'ii10',
    title: 'Revenue intel: Q4 close rates by segment',
    category: 'deal',
    ...
    >
      ...
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: textSecondary }}>
          Team-shared notes, competitive intel, and deal insights
        </p>
      </div>
