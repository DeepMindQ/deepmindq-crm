...
const interactions = [
  {
    date: 'Jan 12',
    type: 'Email',
    summary: 'Discussed Q2 expansion plans and potential partnership opportunities.',
    direction: 'inbound',
  },
  {
    date: 'Jan 05',
    type: 'Meeting',
    summary: "Discovery call — reviewed Acme's current tech stack and pain points.",
    direction: 'outbound',
  },
  {
    date: 'Dec 18',
    type: 'Email',
    summary: 'Follow-up on initial outreach with product overview deck.',
    direction: 'outbound',
  },
  {
    date: 'Dec 10',
    type: 'Call',
    summary: 'Brief introductory call, expressed interest in analytics solutions.',
    direction: 'inbound',
  },
];
...
const associatedSignals = [
  {
    id: 'SIG-007',
    title: 'Executive leadership change at Acme',
    type: 'Leadership',
    confidence: 92,
    time: '1w ago',
  },
  {
    id: 'SIG-012',
    title: 'Sarah Chen speaking at SaaStr Annual',
    type: 'Event',
    confidence: 88,
    time: '2w ago',
  },
...
const associatedInsights = [
  {
    title: 'Active Buying Cycle',
    detail: 'Acme is evaluating cloud infrastructure solutions. Sarah is the economic buyer.',
    confidence: 'high' as const,
  },
  {
    title: 'Relationship Warmth',
    detail: 'Strong rapport established through 4 interactions in the past month.',
    confidence: 'high' as const,
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <Card className="py-0 gap-0">
            <CardContent className="p-6 text-center">
              <div
                className="size-16 rounded-full mx-auto flex items-center justify-center text-lg font-bold"
              ...
              <h2 className="text-lg font-bold mt-3" style={{ color: tokens.text.primary }}>
                {contact.name}
              </h2>
              ...
              <Badge className="mt-2 border-emerald-500/40 bg-emerald-500/15 text-emerald-400">
                {contact.role}
              </Badge>
            </CardContent>
          </Card>
          ...
          <Card className="py-0 gap-0">
            ...
            <CardContent className="px-4 pb-4 space-y-3">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-sm" style={{ color: tokens.accent.primary }}>
                  {contact.domain}
                </span>
              </div>
              <div className="flex items-center gap-2.5">
        ...
        <div className="lg:col-span-2 space-y-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <Badge
                          className={
                            int.direction === 'inbound'
                              ? 'border-emerald-500/40 bg-emerald-500/15 text-emerald-400 text-xs'
                              : 'border-sky-500/40 bg-sky-500/15 text-sky-400 text-xs'
                          }
                        >
                          {int.direction}
                        </Badge>
          ...
          <Card className="py-0 gap-0">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm flex items-center gap-1.5">
                <Zap className="size-3.5" style={{ color: tokens.domain.opportunity }} /> Associated
                Signals
              </CardTitle>
            </CardHeader>
          ...
          <Card className="py-0 gap-0">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm flex items-center gap-1.5">
                <BrainCircuit className="size-3.5" style={{ color: tokens.domain.value }} /> AI
                Insights
              </CardTitle>
            </CardHeader>
            <CardContent className="px-4 pb-4 space-y-3">
