...
const recentInsights = [
  {
    id: '1',
    title: 'Acme Corp expanding engineering team — 15 new roles posted',
  ...
  {
    id: '2',
    title: 'NovaTech CTO published article on cloud migration strategy',
  ...
  {
    id: '3',
    title: 'Pinnacle Health renewed compliance certification — upsell window',
  ...
  {
    id: '4',
    title: 'Quantum Dynamics reduced headcount by 8% — risk alert',
    type: 'risk' as const,
    time: '2h ago',
  ...
  {
    id: '5',
    title: 'SkyBridge Labs secured Series C funding ($45M)',
    type: 'growth' as const,
    time: '3h ago',
...
const healthChecks = [
  ...
  { name: 'Data Enrichment', status: 'degraded' as const, detail: '3 sources delayed' },
  {
    ...
    detail: '89 active recommendations',
  },
];
                ...
                >
                  <defs>
                    ...
                    <linearGradient id="processedGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop
                        offset="5%"
                        stopColor={tokens.confidence.high.value}
                        stopOpacity={0.2}
                      />
