...
function ScreenLoadingFallback({ name }: { name: string }) {
  return <LoadingSkeleton variant="dashboard" label={`Loading ${name.replace(/-/g, ' ')}`} />;
}

/* ── Intelligence OS Screens (new layer) ── */
const IntelligenceOperationsScreen = lazy(() =>
  import('@/components/intelligence-os/intelligence-operations-center').then((m) => ({
    default: m.IntelligenceOperationsCenter,
  })),
);
const CommandCenterScreen = lazy(() =>
  import('@/components/intelligence-os/command-center').then((m) => ({ default: m.CommandCenter })),
);
const ActivationWorkspaceScreen = lazy(() =>
  import('@/components/intelligence-os/activation-workspace').then((m) => ({
...
const CapabilityWorkspaceScreen = lazy(() =>
  import('@/components/intelligence-os/capability-workspace').then((m) => ({
    default: m.CapabilityWorkspace,
  })),
);
const IntelligenceBriefingScreen = lazy(() =>
  import('@/components/intelligence-os/intelligence-briefing').then((m) => ({
    default: m.IntelligenceBriefing,
  })),
);
const IntelligenceSearchScreen = lazy(() =>
  import('@/components/intelligence-os/intelligence-search').then((m) => ({
    default: m.IntelligenceSearch,
  })),
);
...
const RevenueIntelligenceScreen = lazy(
  () => import('@/components/screens/revenue-intelligence-screen'),
);
const SignalIntelligenceScreen = lazy(
  () => import('@/components/screens/signal-intelligence-screen'),
);
const AccountIntelligenceScreen = lazy(
  () => import('@/components/screens/account-intelligence-screen'),
);
const ConversationPlannerScreen = lazy(
  () => import('@/components/screens/conversation-planner-screen'),
);
...
const InternalIntelligenceScreen = lazy(
  () => import('@/components/screens/internal-intelligence-screen'),
);
...
const ConversationStudioScreen = lazy(
  () => import('@/components/screens/conversation-studio-screen'),
);
const StrategyRoomScreen = lazy(() => import('@/components/screens/strategy-room-screen'));
const RelationshipMemoryScreen = lazy(
  () => import('@/components/screens/relationship-memory-screen'),
);
const IntelligenceReasoningScreen = lazy(
  () => import('@/components/screens/intelligence-reasoning-screen'),
);
const IntelligenceReportScreen = lazy(
  () => import('@/components/screens/intelligence-report-screen'),
);
const IntelligenceHealthScreen = lazy(
  () => import('@/components/screens/intelligence-health-screen'),
);
...
const ContactIntelligenceScreen = lazy(
  () => import('@/components/screens/contact-intelligence-screen'),
);
...
const IntelligenceSourcesScreen = lazy(
  () => import('@/components/screens/intelligence-sources-screen'),
);
const IntelligenceInboxScreen = lazy(
  () => import('@/components/screens/intelligence-inbox-screen'),
);
const IntelligenceKnowledgeScreen = lazy(
  () => import('@/components/screens/intelligence-knowledge-screen'),
);
...
const RevenueIntelligenceBriefScreen = lazy(
  () => import('@/components/screens/revenue-intelligence-brief-screen'),
);
const RevenueIntelligenceOpportunitiesScreen = lazy(
  () => import('@/components/screens/revenue-intelligence-opportunities-screen'),
);
const RevenueIntelligenceRecommendationsScreen = lazy(
  () => import('@/components/screens/revenue-intelligence-recommendations-screen'),
);
const AccountRankingScreen = lazy(() => import('@/components/screens/account-ranking-screen'));
const OpportunityWorkspaceScreen = lazy(
  () => import('@/components/screens/opportunity-workspace-screen'),
);
...
const RecommendationQueueScreen = lazy(
  () => import('@/components/screens/recommendation-queue-screen'),
);
const TrustDashboardScreen = lazy(() => import('@/components/screens/trust-dashboard-screen'));
const CompanyTrustDetailScreen = lazy(
  () => import('@/components/screens/company-trust-detail-screen'),
);
const ScoringConfigScreen = lazy(() => import('@/components/screens/scoring-config-screen'));
const MainIntelligenceDashboardScreen = lazy(() =>
  import('@/components/screens/main-intelligence-dashboard').then((m) => ({
    default: m.MainIntelligenceDashboard,
  })),
);
const CompanyWorkspaceV2Screen = lazy(() =>
  import('@/components/screens/company-workspace-v2').then((m) => ({
    default: m.CompanyWorkspaceV2,
  })),
);
const RecommendationQueueV2Screen = lazy(() =>
  import('@/components/screens/recommendation-queue-v2').then((m) => ({
    default: m.RecommendationQueueV2,
  })),
);
const ScoringConfigWizardScreen = lazy(() =>
  import('@/components/screens/scoring-config-wizard').then((m) => ({
    default: m.ScoringConfigWizard,
  })),
);
const BatchOperationsPanelScreen = lazy(() =>
  import('@/components/screens/batch-operations-panel').then((m) => ({
    default: m.BatchOperationsPanel,
  })),
);
const UserOnboardingWizardScreen = lazy(() =>
  import('@/components/onboarding/user-onboarding-wizard').then((m) => ({
    default: m.UserOnboardingWizard,
  })),
);
const AdminSettingsPanelScreen = lazy(() =>
  import('@/components/screens/admin-settings-panel').then((m) => ({
...
export const SCREEN_MAP: Record<ViewId, ScreenComponent> = {
  ...
  'activation-workspace': withScreenErrorBoundary(
    ActivationWorkspaceScreen,
  ...
  'capability-workspace': withScreenErrorBoundary(
    CapabilityWorkspaceScreen,
    'capability-workspace',
  ),
  'intelligence-briefing': withScreenErrorBoundary(
    IntelligenceBriefingScreen,
  ...
  'revenue-intelligence': withScreenErrorBoundary(
    RevenueIntelligenceScreen,
    'revenue-intelligence',
  ),
  'signal-intelligence': withScreenErrorBoundary(SignalIntelligenceScreen, 'signal-intelligence'),
  'account-intelligence': withScreenErrorBoundary(
    AccountIntelligenceScreen,
    'account-intelligence',
  ),
  'internal-intelligence': withScreenErrorBoundary(
    InternalIntelligenceScreen,
    'internal-intelligence',
  ),
  'conversation-planner': withScreenErrorBoundary(
    ConversationPlannerScreen,
  ...
  'revenue-intelligence-brief': withScreenErrorBoundary(
    RevenueIntelligenceBriefScreen,
    'revenue-intelligence-brief',
  ),
  'revenue-intelligence-opportunities': withScreenErrorBoundary(
    RevenueIntelligenceOpportunitiesScreen,
    'revenue-intelligence-opportunities',
  ),
  'revenue-intelligence-recommendations': withScreenErrorBoundary(
    RevenueIntelligenceRecommendationsScreen,
    'revenue-intelligence-recommendations',
  ),
  'recommendation-queue': withScreenErrorBoundary(
    RecommendationQueueScreen,
    'recommendation-queue',
  ),
  'intelligence-reasoning': withScreenErrorBoundary(
    IntelligenceReasoningScreen,
  ...
  'opportunity-workspace': withScreenErrorBoundary(
  ...
  'contact-intelligence': withScreenErrorBoundary(
    ContactIntelligenceScreen,
  ...
  'intelligence-sources': withScreenErrorBoundary(
    IntelligenceSourcesScreen,
    'intelligence-sources',
  ),
  'intelligence-inbox': withScreenErrorBoundary(IntelligenceInboxScreen, 'intelligence-inbox'),
  'intelligence-knowledge': withScreenErrorBoundary(
    IntelligenceKnowledgeScreen,
  ...
  'recommendation-queue-v2': withScreenErrorBoundary(
    RecommendationQueueV2Screen,
