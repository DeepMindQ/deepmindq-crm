...
export const metadata: Metadata = {
  ...
  description:
    'AI-powered enterprise intelligence platform that transforms customer data into actionable revenue intelligence. Dedicated deployment. Customer-owned infrastructure.',
  keywords: [
