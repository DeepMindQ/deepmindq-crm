...
const initialOpps: OppRow[] = [
  ...
  {
    id: 'o8',
    company: 'Catalyst Systems',
    currentRevenue: 1600000,
  ...
  },
  {
    ...
    currentRevenue: 1900000,
    potentialRevenue: 270000,
    growthPct: 14.2,
    confidence: 74,
    signalsCount: 5,
    priority: 'medium',
...
export default function RevenueIntelligenceOpportunitiesScreen() {
  ...
  const filtered = useMemo(() => {
    ...
    if (confidenceFilter === 'high') data = data.filter((o) => o.confidence >= 85);
      ...
      data = data.filter((o) => o.confidence >= 70 && o.confidence < 85);
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: tokens.text.secondary }}>
          AI-identified revenue growth opportunities across your accounts
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="text-xs ml-auto" style={{ color: tokens.text.muted }}>
          {filtered.length} of {initialOpps.length} opportunities
        </span>
      </div>
        ...
        <CardContent className="p-0">
          {filtered.length === 0 ? (
            <EmptyState
              ...
              description="Try adjusting confidence filter"
              className="py-16"
            />
          ) : (
                    ...
                    <TableHead>
                      ...
                      >
                        ...
                        <ArrowUpDown
                          ...
                          style={{
                            color:
                              sortKey === 'growthPct' ? tokens.text.primary : tokens.text.muted,
                          }}
                        />
                      </button>
                    </TableHead>
                    <TableHead>
                      ...
                      >
                        ...
                        <ArrowUpDown
                          ...
                          style={{
                            color:
                              sortKey === 'confidence' ? tokens.text.primary : tokens.text.muted,
                          }}
                        />
                      </button>
                    </TableHead>
                    <TableHead>
                      ...
                      >
                        ...
                        <ArrowUpDown
                          ...
                          style={{
                            color:
                              sortKey === 'signalsCount' ? tokens.text.primary : tokens.text.muted,
                          }}
                        />
                      </button>
                    </TableHead>
