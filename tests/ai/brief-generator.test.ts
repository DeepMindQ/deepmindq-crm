...
import { generateNarrative, calculateBriefConfidence } from '@/lib/revenue-intelligence/brief-generator';
import type { BriefFacts } from '@/lib/revenue-intelligence/brief-generator';
