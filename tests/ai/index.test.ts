...
import {
  ...
  getPrimaryCategory,
  type SignalCategory,
} from '@/lib/revenue-intelligence/signal-patterns';
import { generateNarrative, calculateBriefConfidence, type BriefFacts } from '@/lib/revenue-intelligence/brief-generator';
