...
const company = {
  ...
  description:
    'Leading provider of enterprise cloud solutions serving Fortune 500 companies across 40 countries. Recently announced expansion into AI-driven analytics.',
};
...
const topSignals = [
  {
    title: 'Engineering team expansion — 15 new roles posted in last 30 days',
    type: 'Growth',
    confidence: 94,
    impact: 'High',
  ...
  {
    title: 'CFO Sarah Chen spoke at SaaS Conference about platform consolidation strategy',
    type: 'Intent',
    confidence: 89,
    impact: 'High',
  ...
  {
    title: 'AWS contract renewal approaching — potential multi-cloud strategy shift',
    type: 'Opportunity',
    confidence: 76,
    impact: 'Medium',
...
const keyRisks = [
  {
    risk: 'Competitive threat from VendorX pricing reduction',
    severity: 'high' as const,
    mitigation: 'Strengthen value proposition around TCO and integration depth',
  },
  {
    risk: 'Procurement lead (Lisa Wang) showing negative sentiment',
    severity: 'medium' as const,
    mitigation: 'Engage champion Emily Park to build internal advocacy',
  },
  {
    risk: 'Budget cycle timing — Q2 approvals may delay close',
    severity: 'medium' as const,
    mitigation: 'Offer early-adopter incentives for Q1 commitment',
  },
];
...
const opportunities = [
  ...
  {
    opp: 'Expand from single department to enterprise-wide license',
    potential: '$350K',
    probability: '45%',
  },
...
const recommendedActions = [
  {
    action: 'Schedule 1:1 with CFO Chen to finalize pricing proposal',
    priority: 'high' as const,
    owner: 'AE - John',
    deadline: 'Jan 24',
  },
  {
    action: 'Send technical case study to VP Engineering Rodriguez',
    priority: 'medium' as const,
    owner: 'SE - Alex',
    deadline: 'Jan 22',
  },
  {
    action: 'Prepare competitive comparison deck addressing VendorX TCO',
    priority: 'high' as const,
    owner: 'AE - John',
    deadline: 'Jan 25',
  },
  {
    action: 'Arrange reference call with existing FinTech customer',
              ...
              return (
                <div key={item.label}>
                  <div className="flex items-center gap-1.5 mb-1">
                    <Icon className="w-3 h-3" style={{ color: tokens.text.muted }} />
                    <span
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle
            ...
            style={{ color: tokens.text.primary }}
          >
            <DollarSign className="w-4 h-4" style={{ color: tokens.confidence.high.value }} />{' '}
            Revenue Metrics
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              {
                label: 'Avg Deal Size',
                value: formatCurrency(revenueMetrics.dealSize * 1000),
                sub: 'Last quarter',
                positive: null,
              },
              {
                label: 'Sales Cycle',
                value: `${revenueMetrics.salesCycle}d`,
                sub: '-8d vs avg',
                positive: true,
              },
            ].map((m) => (
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle
              ...
              style={{ color: tokens.text.primary }}
            >
              <Zap className="w-4 h-4" style={{ color: tokens.gold.dark }} /> Top Intelligence
              Signals
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle
              ...
              style={{ color: tokens.text.primary }}
            >
              <AlertTriangle className="w-4 h-4" style={{ color: tokens.confidence.low.value }} />{' '}
              Key Risks
            </CardTitle>
          </CardHeader>
          <CardContent>
                ...
                >
                  <div className="flex items-start gap-2">
                    <Shield
                      ...
                      style={{ color: severityColors[r.severity].text }}
                    />
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span
                          ...
                          style={{
                            backgroundColor: severityColors[r.severity].bg,
                            color: severityColors[r.severity].text,
                          }}
                        >
                          {r.severity}
                        </span>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle
              ...
              style={{ color: tokens.text.primary }}
            >
              <Target className="w-4 h-4" style={{ color: tokens.confidence.high.value }} /> Revenue
              Opportunities
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle
              ...
              style={{ color: tokens.text.primary }}
            >
              <ArrowRight className="w-4 h-4" style={{ color: tokens.accent.primary }} />{' '}
              Recommended Actions
            </CardTitle>
          </CardHeader>
          <CardContent>
