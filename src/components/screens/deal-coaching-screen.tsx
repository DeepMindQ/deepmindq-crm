...
const DEALS = {
  'acme-enterprise': {
    ...
    tips: [
      {
        icon: Target,
        title: 'Focus on CFO Concerns',
        advice:
          'The CFO review is the primary blocker. Prepare a detailed ROI analysis with payback period under 12 months. Include TCO comparison showing 35% savings vs. Competitor A over 3 years.',
      },
      {
        icon: Shield,
        title: 'Address Security Early',
        advice:
          'Competitor A will position their 2-year renewal as lower risk. Proactively share SOC2 Type II, GDPR compliance docs, and data residency guarantees before they become objections.',
      },
      {
        icon: Handshake,
        title: 'Leverage Michael as Champion',
        advice:
          'Michael Torres has presented an internal case study on platform consolidation. Arm him with a one-pager he can share with the CEO and CFO. Offer to co-present in the next executive review.',
      },
      {
        icon: Zap,
        title: 'Create Urgency',
        advice:
          'Propose a limited-time POC with dedicated implementation team. Frame it as "start before budget cycle" to beat Q2 competitor lock-in risk.',
      },
      {
        icon: Award,
        title: 'Differentiate on AI Capabilities',
        advice:
          'Acme is actively hiring ML Engineers. Position our AI/ML module as a unique differentiator that Competitor A lacks. Demo predictive analytics on their actual data.',
      },
    ],
    competitive:
      'Competitor A (incumbent) renewed 2-year contract. Key weakness: limited AI capabilities, slow product velocity. Competitor B (evaluation) has stronger AI but lacks enterprise compliance certifications.',
    nextSteps: [
  ...
  'nexus-fintech': {
    ...
    probability: '45%',
    context:
      'Nexus recently closed Series C ($45M) and is expanding sales team by 40%. COO departure creates leadership instability. Multi-stakeholder buying committee (CEO + CRO + CTO). Currently evaluating 3 vendors including us. The bank partnership requires enterprise-grade compliance.',
    tips: [
      {
        icon: Target,
        title: 'Target CRO as Decision Maker',
        advice:
          'With COO departure, CRO (Priya Sharma) is the key decision maker for sales tech investments. Tailor value proposition around revenue acceleration and pipeline visibility — her core KPIs.',
      },
      {
        icon: Shield,
        title: 'Address Leadership Instability',
        advice:
          'The COO departure is a risk factor. Position our platform as reducing single-point-of-failure dependencies. Show how workflow automation reduces reliance on individual operators.',
      },
      {
        icon: MessageSquare,
        title: 'Multi-Stakeholder Strategy',
        advice:
          'CEO cares about growth metrics. CRO cares about pipeline. CTO cares about integration. Create three versions of the proposal, each speaking to their specific priorities.',
      },
      {
        icon: Zap,
        title: 'Compliance as Differentiator',
        advice:
          'Their bank partnership requires SOC2 + GDPR. We have both certified. Competitor C (cheapest option) only has SOC2. This is a deal-breaker for fintech-bank partnerships.',
      },
    ],
    competitive:
      'Competitor C is 30% cheaper but lacks GDPR certification. Competitor A has strongest brand but 6-month implementation timeline. Our advantage: compliance + speed + growth-focused analytics.',
    nextSteps: [
  ...
  'vertex-startup': {
    ...
    probability: '30%',
    context:
      'Early-stage startup (120 employees) preparing Series A. First sales hire just started. Product-market fit is validated (Gartner Cool Vendor). Budget is constrained until funding closes. Key engineer departed to FAANG — technical talent risk. Need to build relationship before Series A closes and they get vendor-bombed.',
    tips: [
      {
        icon: Lightbulb,
        title: 'Land Before Funding',
        advice:
          'Engage now with a free/low-cost pilot. Post-Series A they will be approached by dozens of vendors. First-mover advantage in establishing the relationship is critical.',
      },
      {
        icon: Target,
        title: 'Focus on Sam Rivera',
        advice:
          'Sam Rivera is building the entire sales process from scratch. Position as a "GTM partner" not just a vendor. Help shape their sales infrastructure — that creates lock-in.',
      },
      {
        icon: TrendingUp,
        title: 'Technical Credibility',
        advice:
          'CTO Marcus Johnson is technical co-founder. Lead with technical depth, not sales pitches. Show architecture docs, API-first approach, and how we handle their specific infrastructure challenges.',
      },
    ],
    competitive:
      'No active competition yet — they are early in evaluation. Risk: they may build in-house with their strong engineering team. Mitigate by showing time-to-value of buying vs. building.',
    nextSteps: [
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: tokens.text.secondary }}>
              AI-powered deal strategy and coaching
            </p>
          </div>
        </div>
        ...
        <CardHeader className="pb-0 pt-0 px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Badge style={{ backgroundColor: tokens.domain.bg, color: tokens.domain.value }}>
                {deal.stage}
              </Badge>
              <Badge
                style={{
