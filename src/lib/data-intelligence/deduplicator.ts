...
import { levenshtein, similarity, normalizeForMatch, companySimilarity } from './dedup-matching-utils';
...
// Matching functions (levenshtein, similarity, normalizeForMatch, companySimilarity)
// are now imported from dedup-matching-utils.ts — single source of truth.
